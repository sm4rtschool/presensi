...
<script type="text/javascript">
	...
	{ 
		$sURL = "/transaksi_approval_ijintl/datatables_pimpinan";
	}
	else If ($this->session->userdata('level') == 'Operator') 
	{
		$sURL = "/transaksi_approval_ijintl/datatables_operator";
	}
	?>
...
<script type="text/javascript">
	...
	function proses_approval_ijintl(id, level)
    {

		$.ajax({
		type:'POST',
		url:'<?php echo site_url().'/transaksi_approval_ijintl/proses_approval_ijintl';?>/'+id,
		success:function(data)
		{
			...
			var size='large';
			var content = data;
			var title = 'Proses Approval Pengajuan Ijin Terlambat Datang Kerja Pegawai Oleh ' + level;
	...
	function petugas_approval_ijintl(id, level, is_pimpinan_approve)
    {

		$.ajax({
		type:'POST',
		url:'<?php echo site_url().'/transaksi_approval_ijintl/petugas_approval_ijintl';?>/'+id,
		success:function(data){
			$('#bddetail').html(data);
			$('.help-block').empty(); // clear error string
			var size='large';
			var content = data;
			var title = 'Proses Approval Pengajuan Ijin Terlambat Datang Kerja Pegawai Oleh Petugas';
...
<script type = "text/javascript">
	function save()
    {
			...
			// ajax adding data to database
          	$.ajax({
            url : "<?php echo site_url(); ?>/transaksi_approval_ijintl/ajax_proses_approval",
            type: "POST",
            data: $('#form').serialize(),
            dataType: "JSON",
            success: function(data)
...
<script type = "text/javascript">
	function petugas_approval_save()
    {
       		...
       		// ajax adding data to database
          	$.ajax({
            url : "<?php echo site_url(); ?>/transaksi_approval_ijintl/ajax_proses_approval_bypetugas",
            type: "POST",
            data: $('#form').serialize(),
            dataType: "JSON",
            success: function(data)
