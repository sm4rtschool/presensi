          ...
          <div class="row">
            <div class="col-xs-12">
			 ...
			 <!--
				...
				<button onclick="location.href='<?php echo site_url(); ?>/msjabatan/add_jabatan'" class="btn btn-primary" type="submit">Tambah User</button>
				</div>				
              </div><!-- /.box -->
    ...
    $(document).ready(function() {
      table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url(); ?>/msjabatan/ajax_list",
            "type": "POST",
