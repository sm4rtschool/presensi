            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
				...
				<div class="box-header with-border">
                  <h3 class="box-title">Isilah data transaksi terlambat datang dengan lengkap dan benar.</h3>
                </div><!-- /.box-header -->
                
				<!-- form start -->
                <form id = "f_konfirmasi_tl" class="form-horizontal" method="POST" action="<?php echo site_url(); ?>/transaksi_ijintl/save_add" enctype="multipart/form-data">
                  ...
                  <div class="box-body">
					...
					<div class="form-group">
                      ...
                      <label for="inputEmail3" class="col-sm-1 control-label">Jumlah Keterlambatan</label>
                      
					  <div class="col-sm-3">
                        <label for="inputEmail3" class="col-sm-1 control-label"><?php echo $val->Late; ?>&nbsp;Menit</label>
                      </div>
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-3">
						...
						<select id = "cboalasan" class="form-control select2" name="cboalasan" required>
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-3">
						...
						<select id = "cbopimpinan" class="form-control select2" name="cbopimpinan" required>
				...
				<!--
                  ...
                  <button type="button" onClick="window.location='<?php echo site_url();?>/transaksi_ijintl/';" class="btn btn-default"><i class="fa fa-undo"></i> Cancel</button>
	...
	$(document).ready(function()
	{
       ...
       // $("#f_konfirmasi_tl").submit(function (e){
        $("#f_konfirmasi_tl").submit(function (){
            //e.preventDefault();
            //e.preventDefault();
		...
		function load_dropdown_alasan(){
			...
			$.ajax({
			url:'<?php echo site_url() . '/transaksi_ijintl/load_dropdown_alasan'; ?>',
			dataType: 'JSON', 
			success: function(data){
					...
					$.each(data.msalasan_tl, function (key, val){
