...
<script type="text/javascript">
	...
	{ 
		$sURL = "/transaksi_ijinpsw/datatables_pegawai";
	}
	...
	function detail_absen(id)
    {
		...
		$.ajax({
		type:'POST',
		url:'<?php echo site_url().'/transaksi_ijinpsw/detail_absen';?>/'+id,
	...
	function konfirmasi_psw(id)
	{
		
		window.location = '<?php echo site_url(); ?>' + '/transaksi_ijinpsw/add_ijinpsw/' + id;
