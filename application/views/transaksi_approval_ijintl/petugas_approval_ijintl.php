	...
	<table class="table table-condensed">
		...
		<tbody>
			...
			<tr>
                ...
                <td>
					<?php If ($is_pimpinan_approve_tl == 0){
					...
					?>
							...
							else If ($is_petugas_approve_tl == 0)
							{
...
?>
<?php
/* End of file petugas_approval_ijintl.php */
/* Location: ./application/views/petugas_approval_ijintl.php */
?>