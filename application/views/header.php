...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Presensi Ditjen P2PL</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo site_url(); ?>/beranda/" class="logo">
          ...
          <span class="logo-mini"><b>WC</b>S</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>SI Kinerja</b></span>
        </a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    <img src="<?php echo base_url(); ?>asset/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image" />
                    <p>
                      <?php echo $nama_lengkap;?> - <?php echo $level;?>
                  ...
                  <li class="user-body">
                    ...
                    <div class="col-xs-4 text-center">
                      <a href="<?php echo site_url(); ?>/msuser/edit_password">Rubah Password</a>
                    </div>
