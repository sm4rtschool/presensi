            ...
            <div class="col-xs-12">
              ...
              <div class="box">
				...
				<div class="box-footer">
					<button onclick="location.href='<?php echo site_url(); ?>/transaksi_kehadiran/add_kehadiran'" class="btn btn-primary" type="submit">Tambah Kehadiran</button>
				</div>
...
<script type="text/javascript">
	...
	{ 
		$sURL = "/transaksi_kehadiran/datatables_pegawai";
	}
