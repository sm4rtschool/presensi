            ...
            <div class="col-xs-12">
              ...
              <div class="box">
				...
				<div class="box-footer">
					<button onclick="location.href='<?php echo site_url(); ?>/transaksi_ketidakhadiran/add_ketidakhadiran'" class="btn btn-primary" type="submit">Tambah Ketidakhadiran</button>
				</div>
...
<script type="text/javascript">
	...
	{ 
		$sURL = "/transaksi_ketidakhadiran/datatables_pegawai";
	}
